                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane {{(isset($activeTab) && ($activeTab == 'profile')) ? 'active' : ''}}" id="profile-data">
                                    <form class="form-horizontal" method="POST" action="{{route('superadmin.profile.update')}}">
                                        @csrf
                                ...
                                <div class="tab-pane {{(isset($activeTab) && ($activeTab == 'change-password')) ? 'active' : ''}}" id="change-password">
                                    <form class="form-horizontal" method="post" action="{{route('superadmin.profile.change-password')}}">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$user->id}}" />
                                        <div class="form-group row">
