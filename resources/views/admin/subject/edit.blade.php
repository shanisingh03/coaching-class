            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        ...
                        <!-- form start -->
                        <form role="form" method="POST" id="subjectUpdateForm"  enctype="multipart/form-data" action="{{route('admin.subject.update',['subject_id'=>$subject->id])}}">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" class="form-control {{$errors->has('subject_name') ? 'is-invalid' : ''}}" id="subjectName"
                                            placeholder="Enter Subject Name" name="subject_name" value="{{old('subject_name') ? old('subject_name') : $subject->subject_name}}" required>
