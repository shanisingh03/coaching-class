            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        ...
                        <!-- form start -->
                        <form role="form" method="POST" id="chapterCreateForm" enctype="multipart/form-data"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{old('chapter_name')}}" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        <div class="text-center">
                                            <img id="subject-image" src="{{asset('images/defaults/subject.png')}}"
...
<script>
    $(function () {
                ...
                $('#chapterCreateForm').on('submit', function (e) {
                    $(".loading").show();
                });
