            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card ">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="POST" id="courseEditForm"  enctype="multipart/form-data" action="{{route('admin.course.update',['course_id'=>$course->id])}}">
                            @csrf
                            <div class="card-body">
                                {{--  Course Name  --}}
                                <div class="row">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control {{$errors->has('course_name') ? 'is-invalid' : ''}}" id="courseName"
                                            placeholder="Enter Course Name" name="course_name" value="{{old('course_name') ? old('course_name') : $course->course_name}}" required>
